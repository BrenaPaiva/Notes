...
<Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 overflow-hidden top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
        ...
        <p className="text-sm leading-6 text-slate-400">
          Comece <button className="font-medium text-lime-400 hover:inderline">gravando uma nota</button > em áudio ou se preferir utilize <button  className="font-medium text-lime-400 hover:inderline">apenas texto</button>.
        </p>
        </div>
